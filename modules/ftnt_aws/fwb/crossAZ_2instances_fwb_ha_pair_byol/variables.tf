...
variable "fwb1_private_ip" {
  description = "Provide the IP address in CIDR form for the private interface of fwb1 (IP from private_subnet)"
  default = "192.168.2.11/24"
}
variable "fwb1_hasync_ip" {
  description = "Provide the IP address for in CIDR form the ha sync interface of fwb1 (IP from hasync_subnet)"
  default = "192.168.3.11/24"
}
variable "fwb1_hamgmt_ip" {
  description = "Provide the IP address in CIDR form for the ha mgmt interface of fwb1 (IP from hamgmt_subnet)"
...
variable "fwb2_private_ip" {
  description = "Provide the IP address in CIDR form for the private interface of fwb2 (IP from private_subnet)"
  default = "192.168.12.12/24"
}
variable "fwb2_hasync_ip" {
  description = "Provide the IP address in CIDR form for the ha sync interface of fwb2 (IP from hasync_subnet)"
  default = "192.168.13.12/24"
}
variable "fwb2_hamgmt_ip" {
  description = "Provide the IP address in CIDR form for the ha mgmt interface of fwb2 (IP from hamgmt_subnet)"
